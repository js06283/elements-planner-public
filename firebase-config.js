			...
			async testConnection() {
				try {
					...
					if (error.code === "permission-denied") {
						...
						console.error("❌ UNAVAILABLE: Firebase service is not available.");
						console.error(
							"🔧 SOLUTION: Check your internet connection and try again."
						);
					} else if (error.code === "invalid-argument") {
						console.error(
							"❌ INVALID ARGUMENT: Firebase configuration is incorrect."
						);
						console.error(
							"🔧 SOLUTION: Check your firebase-config.js file and ensure all values are correct."
						);
					}
					return false;
				}
